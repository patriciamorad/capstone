/* global Vue, VueRouter, axios, Elevator, jQuery */
function runThemeJavaScript() {
  jQuery(document).ready(function($) {
    ...
    if ($(".page-preloading").length) {
      $('a:not([href^="#"])').on("click", function(e) {
        if (
          $(this).attr("class") !== "video-popup-btn" &&
          $(this).attr("class") !== "gallery-item" &&
          $(this).attr("class") !== "ajax-post-link" &&
          $(this).attr("class") !== "read-more ajax-post-link"
        ) {
    ...
    //------------------------------------------------------------------------------
    var $videoBtn = $(
      ".video-popup-btn, .gallery-video, .video-popup-placeholder .play-btn"
    );
    ...
    if (typeof rangeSlider !== "undefined" && rangeSlider !== null) {
      var dataStartMin = parseInt(
          rangeSlider.parentNode.getAttribute("data-start-min"),
          10
        ),
        dataStartMax = parseInt(
          rangeSlider.parentNode.getAttribute("data-start-max"),
          10
        ),
        dataMin = parseInt(rangeSlider.parentNode.getAttribute("data-min"), 10),
        dataMax = parseInt(rangeSlider.parentNode.getAttribute("data-max"), 10),
        dataStep = parseInt(
          rangeSlider.parentNode.getAttribute("data-step"),
          10
        );
